...
static float diffuseLight[]  = {0.6, 0.6, 0.6, 1.0};
...
static float diffuseLight1[]  = {1.00, 1.00, 1.00, 1.0};

float lightPosition[] = {15.0f, 20.0f, 60.0f, 1.0f};
...
static float materialSpecular[] = { 1.0, 1.0, 1.0, 1.0 };
static float shininess          = 120.0;  // # between 1 and 128.
...
void CreateYourOwnMesh()
{
    ...
    gManualTriangleMesh->mShininess=120.0f;
